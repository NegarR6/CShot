        ...
        while self.running:
            ...
            for shot in shoot1.shotsl:
                ...
                if target1.check_collision(shot):
                    ...
                    number_of_shots2_p1 = len(shoot1.shots)
                    if number_of_shots2_p1 - self.number_of_shots1_p1 == 1:
                        self.score1 += 5
                    self.number_of_shots1_p1 = number_of_shots2_p1
                   
                    self.score1 += target1.hit(point1, shoot1.shots, target1)
                    target1.respawn(targets)
                ...
                if target2.check_collision(shot):
                    ...
                    self.score1 += target2.hit(point1, shoot1.shots, target2)
                    target2.respawn(targets)
                ...
                if target3.check_collision(shot):
                    ...
                    self.score1 += target3.hit(point1, shoot1.shots, target3)
                    target3.respawn(targets)
                    
            for shot in shoot2.shotsl:

                if target1.check_collision(shot):
                    #دادن 5 امتیاز اضافه اگر بدون خطا به تارگت بعدی شلیک کرد
                    number_of_shots2_p2 = len(shoot2.shots)
                    if number_of_shots2_p2 - self.number_of_shots1_p2 == 1:
                        self.score2 += 5
                    self.number_of_shots1_p2 = number_of_shots2_p2

                    self.score2 += target1.hit(point2, shoot2.shots, target1)
                    target1.respawn(targets)
                ...
                if target2.check_collision(shot):
                    ...
                    self.score2 += target2.hit(point2, shoot2.shots, target2)
                    target2.respawn(targets)
                ...
                if target3.check_collision(shot):
                    ...
                    self.score2 += target3.hit(point2, shoot2.shots, target3)
                    target3.respawn(targets)
