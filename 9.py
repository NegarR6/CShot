...
class Game:
    ...
    def run(self):
        ...
        xt1, yt1 = random.randint(40, 1125), random.randint(120, 575)
        target1 = Target(xt1, yt1)
        xt2, yt2 = random.randint(40, 1125), random.randint(120, 575)
        target2 = Target(xt2, yt2)
        xt3, yt3 = random.randint(40, 1125), random.randint(120, 575)
        target3 = Target(xt3, yt3)
